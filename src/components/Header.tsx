...
//   useEffect(() => {
//     // синхронизируем состояние если язык меняют извне
...
//     localStorage.setItem('i18nextLng', lng); // уже делает detector, но лишним не будет
//   };
...
export default function Header() {
  ...
  // navItems теперь формируются с использованием t(...) — никаких "жёстких" текстов
  const navItems = [
